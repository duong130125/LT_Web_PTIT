      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col space-y-6">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/m26vuejsb30-cac83.appspot.com/o/%E1%BA%A2nh_ch%E1%BB%A5p_m%C3%A0n_h%C3%ACnh_2024-12-24_104022-removebg-preview.png?alt=media&token=ed5ca9df-20d4-4ae0-8c06-5745d141ce2e"
              alt="Logo"
              className="h-24 w-30"
            />
