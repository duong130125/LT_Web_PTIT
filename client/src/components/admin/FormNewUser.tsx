  ...
  const handleAddUser = async (values: any) => {
    ...
    try {
      ...
      const newUser = {
        ...
        email: values.email,
        profilePicture:
          "https://firebasestorage.googleapis.com/v0/b/m26vuejsb30-cac83.appspot.com/o/pngtree-dark-gray-simple-avatar-png-image_3418404.jpg?alt=media&token=e257beda-0a36-4130-bbd7-e05b085315c7",
        role: 0,
        status: true,
